<?php 
  include('includes/init.inc.OLD.php'); // include the DOCTYPE and opening tags
  include('includes/functions.inc.OLD.php'); // functions
?>
<title>PHP &amp; MySQL - ITWS</title>   

<?php 
  include('includes/head.inc.OLD.php'); 
  // include global css, javascript, end the head and open the body
?>

<h1></h1>
 
<?php include('includes/menubody.inc.OLD.php'); ?>
...
<?php
  ...
  @ $db = new mysqli('localhost', 'root', 'shittywindowtiger', 'iit');
...
<?php include('includes/foot.inc.OLD.php'); 
